                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Add News</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="mt-4" action="/uploads/news_upload.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mt-2 mb-1">
                                            ...
                                            <textarea name="content" rows="12" class="form-control p-2"></textarea>
                                        </div>
